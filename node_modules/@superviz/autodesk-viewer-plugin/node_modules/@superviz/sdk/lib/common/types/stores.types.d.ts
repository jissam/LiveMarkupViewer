...
export type Store<T> = T extends GlobalStore ? StoreApi<typeof useGlobalStore> : T extends WhoIsOnlineStore ? StoreApi<typeof useWhoIsOnlineStore> : T extends VideoStore ? StoreApi<typeof useVideoStore> : T extends Presence3DStore ? StoreApi<typeof usePresence3DStore> : never;
