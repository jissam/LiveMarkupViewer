            ...
            <div className="issue-form-container">
                ...
                <form onSubmit={this.handleSubmit}>
                   ...
                   */}
                    ...
                    <textarea id="issues" name="issues" style={{ width: 'calc(100% - 10px)', height: '110px', resize: 'none', overflow: 'auto' }} className={`form-input ${formSubmitted && !this.state.issues ? 'invalid-input' : ''}`} value={this.state.issues} onChange={this.handleInputChange} ></textarea><br />
                    <button style={{ width: "calc(100% - 10px)" }} type="submit" className="submit-button">Save</button>
